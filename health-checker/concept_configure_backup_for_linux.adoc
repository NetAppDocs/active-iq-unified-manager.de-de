...
+
Wenn Sie beispielsweise ein Backup mit Unified Manager 9.13 erstellt haben, kann das Backup nur auf Unified Manager 9.13-Systemen wiederhergestellt werden.
