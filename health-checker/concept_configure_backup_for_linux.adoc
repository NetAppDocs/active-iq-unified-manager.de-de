...
---
= Konfiguration der Sicherung unter Linux in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Wenn Sie beispielsweise ein Backup auf Unified Manager 9.18 erstellt haben, kann das Backup nur auf Unified Manager 9.18-Systemen wiederhergestellt werden.
