...
---
= Aktualisierung der Active IQ Unified Manager virtuellen Appliance
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können die virtuelle Appliance Active IQ Unified Manager von den Versionen 9.14 oder 9.16 auf 9.18 aktualisieren.
