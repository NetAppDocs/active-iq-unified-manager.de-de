...
---
= Untersuchung von Leistungsereignissen in Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/event_flow.png[Ein UI-Screenshot, der eine Navigation zur Ereignisuntersuchung zeigt.]
