...
---
= Hier wird erläutert, wie Active IQ Unified Manager ein empfangenes Ereignis verarbeitet
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/um_perf_threshold_event_flow.gif[Ein Diagramm, das die Verarbeitung von Schwellenwertereignissen von der Zählererfassung bis zur E-Mail-Benachrichtigung zeigt]
