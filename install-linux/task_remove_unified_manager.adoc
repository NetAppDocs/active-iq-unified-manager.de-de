...
---
= Active IQ Unified Manager entfernen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Dieser Schritt entfernt alle zugehörigen NetApp RPM-Pakete. Die erforderlichen Softwaremodule wie Java, MySQL und 7zip werden nicht entfernt.

. *Optional:* Entfernen Sie gegebenenfalls die unterstützenden Softwaremodule wie Java, MySQL und 7zip:
+
