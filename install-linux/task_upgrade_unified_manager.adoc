...
* MySQL Community Edition wird beim Unified Manager Upgrade automatisch aktualisiert. Wenn die auf Ihrem System installierte Version von MySQL älter als 8.0.37 ist, führt das Upgrade von MySQL durch Unified Manager automatisch ein Upgrade auf 8.0.37 durch.
