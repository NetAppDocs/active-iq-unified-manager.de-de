...
---
= Konfiguration des MySQL-Repositorys für Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn Sie auf einem Red Hat Enterprise Linux 8-System interne Repositories mit java-17-openjdk, 7-zip und anderen Softwarepaketen aus dem AppStream-Repository verwenden, müssen Sie das AppStream-Repository deaktivieren und den MySQL Community Server installieren. Führen Sie folgenden Befehl aus:
