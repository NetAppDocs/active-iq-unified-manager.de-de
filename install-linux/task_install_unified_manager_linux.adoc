...
+
Wenn Sie für ein Red Hat Enterprise Linux 8-System über interne Repositories mit JDK 17 – OpenJDK, p7zip und anderen vom AppStream-Repository bereitgestellten Softwarepaketen verfügen, müssen Sie Ihr AppStream-Repository deaktivieren und MySQL Community Server installieren. Führen Sie den folgenden Befehl aus:
