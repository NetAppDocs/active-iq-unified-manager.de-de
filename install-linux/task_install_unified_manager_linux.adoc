...
---
= Installieren von Active IQ Unified Manager auf Red Hat Enterprise Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
. Falls die installierte Version von MySQL älter als MySQL 8.4.10 Community Edition ist, muss folgender Befehl eingegeben werden, um sie zu deinstallieren:
+
...
+
Wenn Sie auf einem Red Hat Enterprise Linux 8-System interne Repositories mit JDK 17 - OpenJDK, 7-zip und anderen Softwarepaketen aus dem AppStream-Repository verwenden, müssen Sie das AppStream-Repository deaktivieren und den MySQL Community Server installieren. Führen Sie folgenden Befehl aus:
