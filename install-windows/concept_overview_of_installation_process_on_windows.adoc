...
---
= Informationen zum Installationsprozess für Active IQ Unified Manager unter Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/install_flow_on_windows.gif[Ein Diagramm, das die Voraussetzungen, die Installation von Unified Manager und die Schritte des Workflows für die Erstkonfiguration darstellt]
