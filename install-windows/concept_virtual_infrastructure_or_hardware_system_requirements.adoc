...
---
= Informationen zu virtueller Infrastruktur und Hardwareanforderungen für Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Darüber hinaus gibt es eine Begrenzung für die Anzahl der Knoten, die eine einzelne Instanz von Unified Manager überwachen kann, bevor eine zweite Instanz von Unified Manager installiert wird. Empfehlungen zu Knotenlimits, CPU und Arbeitsspeicher sind unter  https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["Leitfaden für bewährte Verfahren für Unified Manager"^] zu finden.
