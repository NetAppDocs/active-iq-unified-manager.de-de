...
Darüber hinaus gibt es eine Begrenzung für die Anzahl der Knoten, die eine einzelne Instanz von Unified Manager überwachen kann, bevor Sie eine zweite Instanz von Unified Manager installieren. Informationen zu Knotenlimits, CPU- und Speicherempfehlungen finden Sie unter https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["Leitfaden für bewährte Verfahren für Unified Manager"^]Die
