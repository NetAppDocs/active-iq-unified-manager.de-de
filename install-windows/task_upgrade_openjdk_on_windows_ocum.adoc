...
---
= OpenJDK unter Windows für Active IQ Unified Manager aktualisieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Laden Sie beispielsweise die `jdk-17.0.15_windows-x64_bin.zip` Datei vonlink:https://www.oracle.com/java/technologies/javase/jdk17-0-13-later-archive-downloads.html["die Seite „Oracle Java SE 17-Archiv-Downloads“"^] .

+

NOTE: Zum Herunterladen der Datei ist ein Oracle-Konto erforderlich. Falls Sie kein Oracle-Konto besitzen, gehen Sie zu link:https://signon.oracle.com/signin["die Oracle-Konto-Anmeldeseite"] um einen zu erstellen.
