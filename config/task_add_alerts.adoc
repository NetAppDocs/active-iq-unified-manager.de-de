...
.Schritte
. Klicken Sie auf *Name*, und geben Sie *HealthTest* in das Feld *Alarmname* ein.
. Klicken Sie auf *Ressourcen*, und wählen Sie in der Einschließen-Registerkarte *Volumes* aus der Dropdown-Liste aus.
+
.. Geben Sie in das Feld *Name enthält* *abc* ein, um die Volumes anzuzeigen, deren Name „`abc`“ enthält.
...
.. Klicken Sie auf *exclude*, und geben Sie *xyz* in das Feld *Name enthält* ein, und klicken Sie dann auf *Hinzufügen*.
