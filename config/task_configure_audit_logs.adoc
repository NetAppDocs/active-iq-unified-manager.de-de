...
---
= Konfiguration der Audit-Protokolle von Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Um die Remote-Protokollierung zu aktivieren, wählen Sie *Remote-Protokollierung aktivieren*.
