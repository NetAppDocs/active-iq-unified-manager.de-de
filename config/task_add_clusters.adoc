...
---
= Cluster zu Active IQ Unified Manager hinzufügen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Dieses Konto muss die Rolle _admin_ besitzen, wobei der Anwendungszugriff auf _ontapi_, _amqp_, _console_ und _http_ festgelegt sein muss.
